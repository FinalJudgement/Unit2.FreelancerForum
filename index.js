...
//Style Elements
body.setAttribute("style", "font-family: sans-serif; border: 1px solid black; width: 30%; min-width: 530px; margin: 0 auto;")
...
createH2.setAttribute("style", "text-align: center; font-size: 2rem; margin-bottom: 10px;")
